            ...
            $.ajax({
                ...
                success: function(response) { 
                    ...
                    for(var index in $comments){
                       var $editButton;
                       //alert($comments[index].user_id+'.......'+$currentUserId);
    ...
    $(function(){
        ...
        /*use parent element with id = comment-section to work with dynamically generated childs with the .comment-update-btn class */     
            ...
            var params = {
                'postId':this.dataset.postId,
                'commentId':this.dataset.commentId,
                'currentUserId':$commentSection.attr('data-crntuser-id'),
                'commentText':$('#comment-text-'+this.dataset.commentId)['0'].innerHTML
            };
